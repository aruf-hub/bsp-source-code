...
Footer.defaultProps = {
  ...
  content2: 'Stay updated with the latest weather forecasts and news.',
  link1: 'About Us',
  link9: 'Advertise with Us',
  cookiesLink: '/cookies-policy',
  content3: '© 2023 Weather Forecast. All rights reserved.',
  link4: 'Blog',
  socialLinkTitleCategory: 'Follow Us',
  link2: 'Contact Us',
  logoSrc: 'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  logoAlt: 'Weather Forecast Logo',
