...
Steps.defaultProps = {
  step4Description:
    'Receive updates and alerts about any changes in the weather forecast.',
  step4Title: 'Stay Informed',
  step1Title: 'Enter Location',
  step3Title: 'View Forecast',
  step3Description:
    'Get detailed weather information for the selected location and date.',
  step2Description: 'Choose the date you want to see the weather forecast for.',
  step1Description: 'Type in the location you want to check the weather for.',
